...
struct Blobby: View {
    ...
    let hollow: Double = 1.0
    let peaks: Double = 1.0
    // 1.0 gives circle, lower gives less circular
    let circleness: Double = 1.0
    ...
    var body: some View {
        ZStack {
            ...
            Blob(boo: boo, sides: segments, height: height, randomness: randomness, density: density, hollow: hollow, circleness: circleness)
